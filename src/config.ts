...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "统计",
			url: "https://umami.yaoxi.cloud/share/9ptO9jjAHNFelZxM", // Internal links should not include the base path, as it is automatically added
...
export const umamiConfig: UmamiConfig = {
	enable: true,
	baseUrl: "https://umami.yaoxi.cloud",
	shareId: "9ptO9jjAHNFelZxM",
